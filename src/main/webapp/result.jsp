...
<%@ page import="com.example.project.Wifi" %>
    ...
    <tbody>
        <tr>
            ...
            <tr>
                ...
                <td><%=wifiInfo.getManagementNumber()%></td>
                <td><%=wifiInfo.getBoroughs()%></td>
                <td><%=wifiInfo.getWifiName()%></td>
                <td><%=wifiInfo.getRoadNameAddress()%></td>
                <td><%=wifiInfo.getDetailedAddress()%></td>
                <td><%=wifiInfo.getInstallationLocationFloor()%></td>
                <td><%=wifiInfo.getInstallationType()%></td>
                <td><%=wifiInfo.getInstallationOrgan()%></td>
                <td><%=wifiInfo.getServiceClassification()%></td>
                <td><%=wifiInfo.getCommunicationsNetwork()%></td>
                <td><%=wifiInfo.getInstallationYear()%></td>
                <td><%=wifiInfo.getIndoorAndOutdoorClassification()%></td>
                <td><%=wifiInfo.getWifiConnectionEnvironment()%></td>
                <td><%=wifiInfo.getxCoordinates()%></td>
                <td><%=wifiInfo.getyCoordinates()%></td>
                <td><%=wifiInfo.getOperationDate()%></td>
            </tr>
